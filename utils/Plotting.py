...
def plot_metric_along_k(ax, k_sizes, performance_nw, performance_wt, title, metric, model_name: str):
    ...
    plot_smooth_curve(ax, k_sizes, performance_wt, label ="%s (w/ OW)"%(model_name), color = "red")
    plot_smooth_curve(ax, k_sizes, performance_nw, label =f"%s (w/o OW, $\\mathit{{{p_val}}}$)"%(model_name), color = "blue")
...
def plot_final_performance_metrics(ax, k_sizes, metric, base_glob_Euc_performance: dict, base_glob_Cos_performance: dict, base_fix_distance_performance_nw: dict, base_opt_distance_performance_nw: dict,
    ...
    plot_smooth_curve(ax, k_sizes, final_model_performance_wt[metric], label = "%s (DO+FO+OW)"%(model_name), color = "red")
    plot_smooth_curve(ax, k_sizes, final_model_performance_nw[metric], label = f"%s (DO+FO, $\\mathit{{{final_nw_p_val}}}$)"%(model_name), color = "blue")
    plot_smooth_curve(ax, k_sizes, base_opt_distance_performance_nw[metric], label = f"%s (DO, $\\mathit{{{base_opt_distance_nw_p_val}}}$)"%(model_name), color = "green")
